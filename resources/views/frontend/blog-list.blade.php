    ...
    <div class="main-wrapper">
	    ...
	    <section class="blog-list px-3 py-5 p-md-5">
		    <div class="container">
			    ...
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="fronted_assets/images/blog/blog-post-thumb-8.jpg" alt="image">
					    <div class="media-body">
						    <h3 class="title mb-1"><a href="blog-post.html">Heading Lorem Ipsum Dolor Sit Amet</a></h3>
			    ...
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="fronted_assets/images/blog/blog-post-thumb-9.jpg" alt="image">
					    <div class="media-body">
			    ...
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="fronted_assets/images/blog/blog-post-thumb-10.jpg" alt="image">
					    <div class="media-body">
			    ...
			    <div class="item mb-5">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="fronted_assets/images/blog/blog-post-thumb-11.jpg" alt="image">
					    <div class="media-body">
			    ...
			    <div class="item">
				    <div class="media">
					    <img class="mr-3 img-fluid post-thumb d-none d-md-flex" src="fronted_assets/images/blog/blog-post-thumb-12.jpg" alt="image">
					    <div class="media-body">
