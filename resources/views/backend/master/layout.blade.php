...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('backend_assets/dist/img/AdminLTELogo.png') }}" alt="AdminLTELogo" height="60" width="60">
  </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('subAdminAdd') }}" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sub-Admin Add</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('subAdminView') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sub-Admin View</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="{{ route('Post_view') }}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                View Post
                <span class="right badge badge-danger">New</span>
